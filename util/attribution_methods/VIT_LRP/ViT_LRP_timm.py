...
def compute_RAVE(all_layer_attentions, all_layer_biases_resid_1, all_layer_biases_resid_2):
    ...
    # print(torch.sum(matrices_aug_resid_1[0, 0, 0], dim=(-1)))
    # print(torch.sum(mlp_resid_1_ratio[0, 0, 0], dim=(-1)))
    # print(torch.sum(matrices_aug_resid_2[0, 0, 0], dim=(-1)))

    # multiply the residual connections and normalize the scale
...
class VisionTransformer(nn.Module):
    ...
    def relprop(self, cam=None,method="transformer_attribution", is_ablation=False, start_layer=0, end_layer=12, withgrad=True, **kwargs):
        ...
        # our method, method name grad is legacy
            ...
            rollout, _ = compute_RAVE(cams, all_layer_biases_resid_1, all_layer_biases_resid_2)
            cam = rollout[:, 0, 1:]
            return cam
